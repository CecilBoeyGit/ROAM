...
public class CustomPixelMask : ScriptableRendererFeature
{
    ...
    public class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, _profilingSampler))
            {
                ...
                settings.blitMaterial.SetTexture("_SonarMaskTexture", rtCustomColor);
                ...
                if (settings.blitMaterial != null)
                {
                    ...
                    {
                        settings.blitMaterial.SetTexture("_MainTexture", renderingData.cameraData.renderer.cameraColorTargetHandle);
                        ...
                        //cmd.Blit(camTarget, rtTempColor, settings.blitMaterial, 0);
                        //cmd.Blit(rtTempColor, camTarget);
                    }
                }
            }
